...
void epd_lcd_deinit(void); // Added (void) for consistency, though not strictly necessary for C if no params
void epd_lcd_frame_done_cb(frame_done_func_t cb, void* payload); // Added parameter names for clarity
void epd_lcd_line_source_cb(line_cb_func_t cb, void* payload);  // Added parameter names for clarity
void epd_lcd_start_frame(void); // Added (void)
/**
